 ...
 * @return - Middleware function to validate the request params
 * 
 */
export const validateParams = (schema: AnyZodObject) => {
    return async (req: Request, res: Response, next: NextFunction) => {
      try {
        logger.info("Validating request params", { params: req.params });
        ...
        logger.error("Request params are invalid", { error });
